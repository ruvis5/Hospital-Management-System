	...
	<body>
		...
		<div class="container-fluid">
			...
			<div class="row navbar-fixed-top">
				...
				<a href="index.jsp"
					style="text-align:Center;font-weight:bold;font-size:120%;padding: 0 2%;color:red">LOGIN</a>
			</div>
			<!--- Header Ends Here --------------------------->
					...
					<div class="panel panel-default login">
						...
						<div class="panel-body">
							<form class="form-horizontal center-block" role="form"
								action="register_patient_validation.jsp" method="post" style="margin-top: 70px;">

								<div class="form-group">
									<label class="col-sm-2 control-label">Patient Id:</label>
									<div class="col-sm-10">
										<input type="number" class="form-control" name="patientid"
											placeholder="unique_id auto generated" readonly>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" value="" name="roomNo"
											placeholder="Left for Admin" readonly>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" name="doct" placeholder="Left for Admin"
											readonly>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<div class="col-sm-7 col-sm-offset-2" style="margin:0 0 0 40%">
										<button type="submit" class="btn btn-primary" style="background-color: #92c86d;">Register As Patient Now</button>
									</div>
								</div>
								<br><Br><Br>
