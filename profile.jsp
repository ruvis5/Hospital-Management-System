                ...
                <form class="form-horizontal" action="edit_staff_validation.jsp">
                    ...
                    <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                    <button type="submit" class="btn btn-primary" style="background-color: #92c86d;">Update Profile</button>
                            </div>
                    </div>
                </form>															
            </div>
        ...
        <!----------------   Panel body Start   --------------->
            <div class="panel-body">
                <form class="form-horizontal" action="add_staff_validation.jsp">
                    ...
                    <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                    <button type="submit" class="btn btn-primary" style="background-color: #92c86d;">Add New Admin Profile</button>
                            </div>
                    </div>
                </form>															
            </div>
    ...
    <div class="panel panel-default contentinside">
        ...
        <div class="panel-body">
            <form class="form-horizontal" action="change_pass_validation.jsp">
                ...
                <div class="form-group">
                       <div class="col-sm-offset-2 col-sm-10">
                       <button type="submit" class="btn btn-primary" style="background-color: #92c86d;">Update Password</button>
                       </div>
               </div>
            </form>
        </div>
