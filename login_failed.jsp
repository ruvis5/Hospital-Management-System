...
<% response.setHeader("cache-control","no-cache,no-store,must-revalidate"); String
	emaill=(String)session.getAttribute("email"); if(emaill!=null) response.sendRedirect("admin.jsp"); %>
	<html lang="en">
		...
		<div class="container-fluid">
			...
			<div class="row ">
				<div class="col-md-12" style="margin-top: 150px;">
					...
					<div style="text-align:center;font-weight:bold;color:red">Login Failed.Check Username or Password.
					</div>
				</div>
			</div>
